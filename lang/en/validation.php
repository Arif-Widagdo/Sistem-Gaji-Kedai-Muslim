    ...
    */
    ...
    'custom' => [
        'oldpassword' => [
            ...
            'min' => 'Current password must have atleast 6 characters',
            'max' => 'Current Password must not be greater than 30 characters',
        ],
        'newpassword' => [
            'required' => 'Enter new password',
            'min' => 'Password must have atleast 8 characters',
            'max' => 'Password must not be greater than 30 characters',
        ],
        'cnewpassword' => [
